...
a persistence unit "ExamenAngelJadanServidorPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ExamenAngelJadanServidor\pom.xml":
...
artifact ("ExamenAngelJadanServidor.war") is already built. You can build
